      ...
      <form action={formAction} className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              type="text"
              name="codigoSku"
              key={`sku-${state?.inputs?.codigoSku ?? ''}`}
              defaultValue={state?.inputs?.codigoSku ?? ''}
              required
          ...
          <div>
            ...
            <input
              ...
              min="0"
              name="preco"
              key={`preco-${state?.inputs?.preco ?? ''}`}
              defaultValue={state?.inputs?.preco ?? ''}
              required
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              type="text"
              name="categoria"
              key={`categoria-${state?.inputs?.categoria ?? ''}`}
              defaultValue={state?.inputs?.categoria ?? ''}
        ...
        <div>
          ...
          <input
            type="number"
            name="estoque"
            key={`estoque-${state?.inputs?.estoque ?? '0'}`}
            defaultValue={state?.inputs?.estoque ?? '0'}
            required
            min="0"
            placeholder="Ex: 50"
            className="w-full px-3.5 py-2 border border-slate-300 rounded-lg text-sm text-slate-900 outline-none focus:ring-2 focus:ring-blue-500"
        ...
        <div>
          ...
          <textarea
            name="descricao"
            key={`desc-${state?.inputs?.descricao ?? ''}`}
            defaultValue={state?.inputs?.descricao ?? ''}
            rows={3}
